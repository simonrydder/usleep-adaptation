...
from csdp.csdp_pipeline.pipeline_elements.pipeline import (
    PipelineConfiguration,
    PipelineDataset,
)
from csdp.csdp_pipeline.pipeline_elements.samplers import SamplerConfiguration
...
class Dataloader_Factory(IDataloader_Factory):
    ...
    def training_loader(self, num_workers=1) -> DataLoader:
        ...
        dataset = PipelineDataset(
            self.samplers.get_sampler_by_stage("train"),
    ...
    def validation_loader(self, num_workers=1) -> DataLoader:
        ...
        dataset = PipelineDataset(
            sampler, self.pipe_configuration.get_pipe_by_stage("val")
        )
    ...
    def testing_loader(self, num_workers=1) -> DataLoader:
        ...
        dataset = PipelineDataset(
            sampler, self.pipe_configuration.get_pipe_by_stage("test")
        )

...
from src.csdp_pipeline.factories.pipeline_factory import (
    LSeqSleepNet_Pipeline_Factory,
    USleep_Pipeline_Factory,
)
from src.csdp_pipeline.pipeline_elements.pipeline_dataset import PipelineDataset
from src.csdp_training.utility import create_split_file
...
class USleep_Dataloader_Factory(IDataloader_Factory):
    def __init__(
        ...
        Args:
            ...
            data_split_path (str, optional): Specifies a path to a split json file. For examples, look in the folder "src.csdp_pipeline/splits" of this repository. Defaults to None, which means all subjects are used for both training, validation and test.

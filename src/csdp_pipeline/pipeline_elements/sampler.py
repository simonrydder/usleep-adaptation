...
class Sampler(IPipe):
    def __init__(
        ...
        print(
            f"Number of {split_type} subjects: {len(self.subjects)} records: {self.num_records} - subject percentage: {subject_percentage}"
        )
